...
public class ColorMapping_20w45a implements ColorMapping {

	private static final Logger LOGGER = LogManager.getLogger(ColorMapping_20w45a.class);
	...
	static {
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping_20w45a.class.getClassLoader().getResourceAsStream("mapping/java_1_17/colors.txt"))))) {
			String line;
			...
			throw new RuntimeException("failed to read mapping/java_1_17/colors.txt");
		}
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping.class.getClassLoader().getResourceAsStream("mapping/java_1_17/biome_colors.txt"))))) {
			...
			throw new RuntimeException("failed to read mapping/java_1_17/biome_colors.txt");
		}
	}
