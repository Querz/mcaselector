...
public class ColorMapping_15w32a implements ColorMapping {

	private static final Logger LOGGER = LogManager.getLogger(ColorMapping_15w32a.class);

	private static final Map<Integer, Integer> mapping = new HashMap<>();
	private static final Set<Integer> grass = new HashSet<>();
	private static final Set<Integer> foliage = new HashSet<>();
	...
	static {
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping_15w32a.class.getClassLoader().getResourceAsStream("mapping/java_1_9/colors.txt"))))) {
			String line;
			...
			throw new RuntimeException("failed to read mapping/java_1_9/colors.txt");
		}
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping.class.getClassLoader().getResourceAsStream("mapping/java_1_9/biome_colors.txt"))))) {
			...
			throw new RuntimeException("failed to read mapping/java_1_9/biome_colors.txt");
		}
	}
