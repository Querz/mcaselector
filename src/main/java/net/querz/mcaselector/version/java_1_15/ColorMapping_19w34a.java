...
public class ColorMapping_19w34a implements ColorMapping {

	private static final Logger LOGGER = LogManager.getLogger(ColorMapping_19w34a.class);
	...
	static {
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping_19w34a.class.getClassLoader().getResourceAsStream("mapping/java_1_15/colors.txt"))))) {
			String line;
			...
			throw new RuntimeException("failed to read mapping/java_1_15/colors.txt");
		}
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping.class.getClassLoader().getResourceAsStream("mapping/java_1_15/biome_colors.txt"))))) {
			...
			throw new RuntimeException("failed to read mapping/java_1_15/biome_colors.txt");
		}
	}
