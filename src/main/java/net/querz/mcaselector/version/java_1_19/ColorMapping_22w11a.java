...
public class ColorMapping_22w11a implements ColorMapping {

	private static final Logger LOGGER = LogManager.getLogger(ColorMapping_22w11a.class);
	...
	static {
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping_22w11a.class.getClassLoader().getResourceAsStream("mapping/java_1_19/colors.txt"))))) {
			String line;
			...
			throw new RuntimeException("failed to read mapping/java_1_19/colors.txt");
		}

		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping.class.getClassLoader().getResourceAsStream("mapping/java_1_19/biome_colors.txt"))))) {
			...
			throw new RuntimeException("failed to read mapping/java_1_19/biome_colors.txt");
		}
	}
