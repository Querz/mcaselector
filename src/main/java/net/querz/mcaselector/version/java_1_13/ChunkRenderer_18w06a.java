...
public class ChunkRenderer_18w06a implements ChunkRenderer<CompoundTag, Integer> {
	...
	private int getBiome(int x, int z, IntBuffer biomes) {
		if (biomes == null || biomes.limit() != 256) {
			return 0;
		}
		int b = biomes.get(z * 16 + x);
