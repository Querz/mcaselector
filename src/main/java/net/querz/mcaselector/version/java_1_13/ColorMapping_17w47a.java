...
public class ColorMapping_17w47a implements ColorMapping {

	private static final Logger LOGGER = LogManager.getLogger(ColorMapping_17w47a.class);
	...
	static {
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping_17w47a.class.getClassLoader().getResourceAsStream("mapping/java_1_13/colors.txt"))))) {
			String line;
			...
			throw new RuntimeException("failed to read mapping/java_1_13/colors.txt");
		}
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping.class.getClassLoader().getResourceAsStream("mapping/java_1_13/biome_colors.txt"))))) {
			...
			throw new RuntimeException("failed to read mapping/java_1_13/biome_colors.txt");
		}
	}
