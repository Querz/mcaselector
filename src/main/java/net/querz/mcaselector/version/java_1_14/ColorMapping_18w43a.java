...
public class ColorMapping_18w43a implements ColorMapping {

	private static final Logger LOGGER = LogManager.getLogger(ColorMapping_18w43a.class);
	...
	static {
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping_18w43a.class.getClassLoader().getResourceAsStream("mapping/java_1_14/colors.txt"))))) {
			String line;
			...
			throw new RuntimeException("failed to read mapping/java_1_14/colors.txt");
		}
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping.class.getClassLoader().getResourceAsStream("mapping/java_1_14/biome_colors.txt"))))) {
			...
			throw new RuntimeException("failed to read mapping/java_1_14/biome_colors.txt");
		}
	}
