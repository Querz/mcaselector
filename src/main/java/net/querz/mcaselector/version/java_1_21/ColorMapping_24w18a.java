...
public class ColorMapping_24w18a implements ColorMapping {

	private static final Logger LOGGER = LogManager.getLogger(ColorMapping_24w18a.class);
	...
	static {
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping_24w18a.class.getClassLoader().getResourceAsStream("mapping/java_1_21/colors.txt"))))) {
			String line;
			...
			throw new RuntimeException("failed to read mapping/java_1_21/colors.txt");
		}

		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping.class.getClassLoader().getResourceAsStream("mapping/java_1_21/biome_colors.txt"))))) {
			...
			throw new RuntimeException("failed to read mapping/java_1_21/biome_colors.txt");
		}
	}
