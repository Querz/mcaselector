...
public class ColorMapping_24w18a implements ColorMapping<CompoundTag, String> {

	private static final ColorConfig cfg = FileHelper.loadFromResource("mapping/java_1_21/colors_24w18a.json", ColorConfig::load);
