...
public class ColorMapping_25w02a implements ColorMapping {
	...
	static {
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping_25w02a.class.getClassLoader().getResourceAsStream("mapping/java_1_22/colors.txt"))))) {
			String line;
			...
			throw new RuntimeException("failed to read mapping/java_1_22/colors.txt");
		}

		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping.class.getClassLoader().getResourceAsStream("mapping/java_1_22/biome_colors.txt"))))) {
			...
			throw new RuntimeException("failed to read mapping/java_1_22/biome_colors.txt");
		}
	}
