...
public class ColorMapping_23w12a implements ColorMapping<CompoundTag, String> {

	private static final ColorConfig cfg = FileHelper.loadFromResource("mapping/java_1_20/colors_23w12a.json", ColorConfig::load);
