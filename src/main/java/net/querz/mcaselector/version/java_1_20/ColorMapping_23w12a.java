...
public class ColorMapping_23w12a implements ColorMapping {

	private static final Logger LOGGER = LogManager.getLogger(ColorMapping_23w12a.class);
	...
	static {
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping_23w12a.class.getClassLoader().getResourceAsStream("mapping/java_1_20/colors.txt"))))) {
			String line;
			...
			throw new RuntimeException("failed to read mapping/java_1_20/colors.txt");
		}

		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping.class.getClassLoader().getResourceAsStream("mapping/java_1_20/biome_colors.txt"))))) {
			...
			throw new RuntimeException("failed to read mapping/java_1_20/biome_colors.txt");
		}
	}
