...
public class ColorMapping_20w06a implements ColorMapping {

	private static final Logger LOGGER = LogManager.getLogger(ColorMapping_20w06a.class);
	...
	static {
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping_20w06a.class.getClassLoader().getResourceAsStream("mapping/java_1_16/colors.txt"))))) {
			String line;
			...
			throw new RuntimeException("failed to read mapping/java_1_16/colors.txt");
		}
		...
		try (BufferedReader bis = new BufferedReader(
				new InputStreamReader(Objects.requireNonNull(ColorMapping.class.getClassLoader().getResourceAsStream("mapping/java_1_16/biome_colors.txt"))))) {
			...
			throw new RuntimeException("failed to read mapping/java_1_16/biome_colors.txt");
		}
	}
