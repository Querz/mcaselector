...
public enum Translation {
	...
	DIALOG_IMPORT_SELECTION_SUBTRACT("dialog.import_selection.subtract"),
	...
	DIALOG_FILTER_CHUNKS_ADD_SELECTION("dialog.filter_chunks.add_selection"),
	DIALOG_FILTER_CHUNKS_SUBTRACT_SELECTION("dialog.filter_chunks.subtract_selection"),
	...
	DIALOG_REPLACE_BLOCKS_BUILDER_BUTTON("dialog.replace_blocks.builder.button"),
	DIALOG_REPLACE_BLOCKS_BUILDER_TITLE("dialog.replace_blocks.builder.title"),
	DIALOG_REPLACE_BLOCKS_BUILDER_FROM("dialog.replace_blocks.builder.from"),
	DIALOG_REPLACE_BLOCKS_BUILDER_TO("dialog.replace_blocks.builder.to"),
	DIALOG_REPLACE_BLOCKS_BUILDER_ADD_RULE("dialog.replace_blocks.builder.add_rule"),
	DIALOG_REPLACE_BLOCKS_BUILDER_DELETE_RULE("dialog.replace_blocks.builder.delete_rule"),
	DIALOG_REPLACE_BLOCKS_BUILDER_RULES("dialog.replace_blocks.builder.rules"),
	DIALOG_REPLACE_BLOCKS_BUILDER_RULES_EMPTY("dialog.replace_blocks.builder.rules.empty"),
	DIALOG_REPLACE_BLOCKS_BUILDER_RESULT("dialog.replace_blocks.builder.result"),
	DIALOG_REPLACE_BLOCKS_BUILDER_INVALID("dialog.replace_blocks.builder.invalid"),
	DIALOG_REPLACE_BLOCKS_BUILDER_DUPLICATE("dialog.replace_blocks.builder.duplicate"),
	DIALOG_REPLACE_BLOCKS_BUILDER_EMPTY("dialog.replace_blocks.builder.empty"),
	DIALOG_REPLACE_BLOCKS_BUILDER_ADVANCED("dialog.replace_blocks.builder.advanced"),
	...
	DIALOG_REPLACE_BLOCKS_BUILDER_Y_MIN("dialog.replace_blocks.builder.y_min"),
	DIALOG_REPLACE_BLOCKS_BUILDER_Y_MAX("dialog.replace_blocks.builder.y_max"),
	...
	DIALOG_REPLACE_BLOCKS_BUILDER_SOURCE_CONSTRAINTS("dialog.replace_blocks.builder.source_constraints"),
	...
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET("dialog.replace_blocks.builder.preset"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_PROMPT("dialog.replace_blocks.builder.preset.prompt"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_APPLY("dialog.replace_blocks.builder.preset.apply"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_SAVE("dialog.replace_blocks.builder.preset.save"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_DELETE("dialog.replace_blocks.builder.preset.delete"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_TITLE("dialog.replace_blocks.builder.preset.title"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_SAVE_TITLE("dialog.replace_blocks.builder.preset.save.title"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_SAVE_HEADER("dialog.replace_blocks.builder.preset.save.header"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_SAVE_NAME("dialog.replace_blocks.builder.preset.save.name"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_NAME_EMPTY("dialog.replace_blocks.builder.preset.name_empty"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_BUILTIN_LOCKED("dialog.replace_blocks.builder.preset.builtin_locked"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_OVERWRITE_CONFIRM("dialog.replace_blocks.builder.preset.overwrite_confirm"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_DELETE_CONFIRM("dialog.replace_blocks.builder.preset.delete_confirm"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_REPLACE_CONFIRM("dialog.replace_blocks.builder.preset.replace_confirm"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_SAVED("dialog.replace_blocks.builder.preset.saved"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_PERSIST_FAILED("dialog.replace_blocks.builder.preset.persist_failed"),
	...
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_ORES_TO_STONE("dialog.replace_blocks.builder.preset.ores_to_stone"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_CONTAINERS_TO_AIR("dialog.replace_blocks.builder.preset.containers_to_air"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_WARNING_AIR("dialog.replace_blocks.builder.preset.warning_air"),
	DIALOG_REPLACE_BLOCKS_BUILDER_PRESET_WARNING_CONTAINERS("dialog.replace_blocks.builder.preset.warning_containers"),
	DIALOG_REPLACE_BLOCKS_BUILDER_EDIT_RULE("dialog.replace_blocks.builder.edit_rule"),
	...
	DIALOG_REPLACE_BLOCKS_BUILDER_HELP_NBT_INTRO("dialog.replace_blocks.builder.help.nbt.intro"),
	DIALOG_REPLACE_BLOCKS_BUILDER_HELP_NBT_ANY("dialog.replace_blocks.builder.help.nbt.any"),
	DIALOG_REPLACE_BLOCKS_BUILDER_HELP_NBT_PRESENT("dialog.replace_blocks.builder.help.nbt.present"),
	DIALOG_REPLACE_BLOCKS_BUILDER_HELP_NBT_ABSENT("dialog.replace_blocks.builder.help.nbt.absent"),
	DIALOG_REPLACE_BLOCKS_BUILDER_HELP_NBT_NOTE("dialog.replace_blocks.builder.help.nbt.note"),
	DIALOG_REPLACE_BLOCKS_BUILDER_HELP_BIOME_TITLE("dialog.replace_blocks.builder.help.biome.title"),
	DIALOG_REPLACE_BLOCKS_BUILDER_HELP_BIOME_INTRO("dialog.replace_blocks.builder.help.biome.intro"),
	DIALOG_REPLACE_BLOCKS_BUILDER_HELP_BIOME_SYNTAX("dialog.replace_blocks.builder.help.biome.syntax"),
	DIALOG_REPLACE_BLOCKS_PREVIEW_BUTTON("dialog.replace_blocks.preview.button"),
	DIALOG_REPLACE_BLOCKS_PREVIEW_TITLE("dialog.replace_blocks.preview.title"),
	DIALOG_REPLACE_BLOCKS_PREVIEW_NO_FIELD("dialog.replace_blocks.preview.no_field"),
	DIALOG_REPLACE_BLOCKS_PREVIEW_RESULT("dialog.replace_blocks.preview.result"),
	DIALOG_REPLACE_BLOCKS_PREVIEW_RULES("dialog.replace_blocks.preview.rules"),
	DIALOG_REPLACE_BLOCKS_PREVIEW_RULE("dialog.replace_blocks.preview.rule"),
	DIALOG_REPLACE_BLOCKS_PREVIEW_WARNING_AIR("dialog.replace_blocks.preview.warning_air"),
	...
	DIALOG_REPLACE_BLOCKS_VALIDATION_SOURCE_EMPTY("dialog.replace_blocks.validation.source_empty"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_TARGET_EMPTY("dialog.replace_blocks.validation.target_empty"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_SOURCE_UNKNOWN("dialog.replace_blocks.validation.source_unknown"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_TARGET_UNKNOWN("dialog.replace_blocks.validation.target_unknown"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_SOURCE_FORMAT("dialog.replace_blocks.validation.source_format"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_TARGET_FORMAT("dialog.replace_blocks.validation.target_format"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_MISSING_EQUALS("dialog.replace_blocks.validation.missing_equals"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_SOURCE_STATE_SNBT("dialog.replace_blocks.validation.source_state_snbt"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_STATE_SNBT("dialog.replace_blocks.validation.state_snbt"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_TILE_EMPTY("dialog.replace_blocks.validation.tile_empty"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_TILE_SNBT("dialog.replace_blocks.validation.tile_snbt"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_TRAILING("dialog.replace_blocks.validation.trailing"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_TARGET_QUOTE("dialog.replace_blocks.validation.target_quote"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_QUOTED_TARGET_AMBIGUOUS("dialog.replace_blocks.validation.quoted_target_ambiguous"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_SOURCE_REGEX("dialog.replace_blocks.validation.source_regex"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_SOURCE_MODE_WRAPPER("dialog.replace_blocks.validation.source_mode_wrapper"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_SOURCE_LITERAL("dialog.replace_blocks.validation.source_literal"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_SOURCE_REGEX_SYNTAX("dialog.replace_blocks.validation.source_regex_syntax"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_SOURCE_PROPS("dialog.replace_blocks.validation.source_props"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_SOURCE_Y_RANGE("dialog.replace_blocks.validation.source_y_range"),
	DIALOG_REPLACE_BLOCKS_VALIDATION_SOURCE_BIOME("dialog.replace_blocks.validation.source_biome"),
	DIALOG_CHANGE_NBT_QUERY_INVALID("dialog.change_nbt.query_invalid"),
	DIALOG_CHANGE_NBT_REPLACE_BLOCKS_QUERY_QUOTE("dialog.change_nbt.replace_blocks_query_quote"),
	...
	DIALOG_PROGRESS_TITLE_PREVIEW_REPLACE_BLOCKS("dialog.progress.title.preview_replace_blocks"),
