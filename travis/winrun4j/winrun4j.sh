...
cd build/tmp/winrun4j

wget https://github.com/poidasmith/winrun4j/files/1822558/winrun4J-0.4.5.zip -O winrun4j.zip
unzip winrun4j.zip
rm winrun4j.zip
...
# add config to WinRun4J.exe
echo "assembling winrun4j"
wine "C:\winrun4j\RCEDIT64.exe" "/I" "WinRun4J64.exe" "$(winepath -w "~/inno/icon.ico")"
wine "C:\winrun4j\RCEDIT64.exe" "/N" "WinRun4J64.exe" "$(winepath -w "~/travis/winrun4j/winrun4j.ini")"
