...
wget http://www.angusj.com/resourcehacker/reshacker_setup.exe -O build/tmp/winrun4j/resourcehackersetup.exe
...
mkdir -p ~/".wine/drive_c/winrun4j"
cp build/tmp/winrun4j/resourcehackersetup.exe ~/".wine/drive_c/winrun4j"
cp travis/winrun4j/resource.rc ~/".wine/drive_c/winrun4j"

wine "C:\winrun4j\resourcehackersetup.exe"
wine "ResourceHacker" "-open C:\winrun4j\resource.rc -save C:\winrun4j\resource.rec -action compile"
wine "ResourceHacker" "-open $exePath -save $exePath -action add -resource C:\winrun4j\resource.rec"
